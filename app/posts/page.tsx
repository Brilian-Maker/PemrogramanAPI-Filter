import dataJson from "../public/data/war.json";
...
const UserList = () => {
  ...
  return (
    <>
      ...
      <h1 className="text-fuchsia-500">HALAMAN USER</h1>
      <center><h3>SEMUA DATA</h3></center>
      {users.map((user) => (
      ...
      <center><h3>DATA DENGAN NAMA ("John")</h3></center>
      {namaJohn.map((user) => (
        <CardList key={user.id}>
          <p>Nama: {user.name}</p>
          {user.hobbies && user.hobbies.length > 0 && (
      ...
      <center><h3>DATA DENGAN ALAMAT NEW YORK</h3></center>
      ...
      <center><h3>DATA DENGAN UMUR LEBIH DARI 30 TAHUN</h3></center>
